...
/**
 * Test cases for the InsertionSorter 
 * @author Dr.King 
 * @author Diya Patel 
 */
public class InsertionSorterTest {
	...
	/** natural order */
	private InsertionSorter natural; 
	
	/** gpa order */ 
	private InsertionSorter gpa; 

	/** id order */ 
	private InsertionSorter id;
	...
	public void setUp() {
		...
		gpa = new InsertionSorter<>(new StudentGPAComparator());
		id = new InsertionSorter<>(new StudentIDComparator()); 
		natural = new InsertionSorter<>(null); 
	}

	/**
	 * test cases using the three arrays to see if it is sorted properly 
	 */
	@Test
