...
public class UpTreeDisjointSetForest<E> implements DisjointSetForest<E> {
    ...
    /**
     * 
     * The code for this method is based on the makeCluster algorithm on page 676 in the course textbook
    ...
    public Position<E> find(E value) {
    	...
    	UpTreeNode<E> root = findHelper(loc); 
    	return root; 
    }

    /**
     * The code for this method is based on the find algorithm on page 676 in the course textbook
     * "Data Structures and Algorithms" by Goodrich, Tamassia, Goldwasser.
     * 
    ...
    /**
     * The code for this method is based on the union algorithm on page 676 in the course textbook
     * "Data Structures and Algorithms" by Goodrich, Tamassia, Goldwasser.
     * 
    ...
    /**
     * validates the position of the node
