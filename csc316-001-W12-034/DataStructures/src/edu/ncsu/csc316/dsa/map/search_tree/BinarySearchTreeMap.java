...
public class BinarySearchTreeMap<K extends Comparable<K>, V> extends AbstractOrderedMap<K, V> {
    ...
    /**
     * puts an entry with the given key and value 
     * 
     * @param value the value of the entry 
     * @param key the key of the entry 
     * @return original the original value of the key 
     */
    @Override
     ...
     * 
     * @return collection the tree when its iterateed 
     */
    @Override
    ...
    protected static class BalanceableBinaryTree<K, V> extends LinkedBinaryTree<Entry<K, V>> {
        ...
        public Position<Entry<K, V>> restructure(Position<Entry<K, V>> x) {
            ...
            if((parent.getLeft() == node && grandparent.getLeft() == parent) || (parent.getRight() == node && grandparent.getRight() == parent)) {
         ...
         * @return newNode the new node that was created 
         */
        @Override
    ...
    /**
     * retures the entry that was removed 
     * 
