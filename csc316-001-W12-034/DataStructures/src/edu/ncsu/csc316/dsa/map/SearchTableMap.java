...
public class SearchTableMap<K extends Comparable<K>, V> extends AbstractOrderedMap<K, V> {
    ...
    /**
     * helps locate where a value should be inserted to maintain sortered order
     * @param min index of the list 
     * @param max index of the list 
     * @param key the key to find 
     * @return index the index where the entry should be added 
     */
    ...
    /**
     * puts the entry with the key and value to the list 
     * @param key the key to add 
     * @param value the value at the key 
     * @return original the orginal value at the key 
     */
    @Override
     ...
     * @return org the value the value that was removed 
     */
    @Override
    ...
    /**
     * creates a string of the objects in the entries 
